...
export default function ProjectsSection() {
  ...
  const ProfessionalProjectCard = ({ project }: { project: any }) => (
    <Card className="flex flex-col overflow-hidden border-2 border-border/80 shadow-lg transition-shadow hover:shadow-primary/20 md:flex-row">
  ...
  const PersonalProjectCard = ({ project }: { project: any }) => (
    <Card className="overflow-hidden border-2 border-border/80 shadow-lg transition-shadow hover:shadow-primary/20">
